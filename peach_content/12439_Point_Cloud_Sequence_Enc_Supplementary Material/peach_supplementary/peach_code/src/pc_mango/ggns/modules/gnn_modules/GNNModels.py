...
from pc_mango.ggns.modules.gnn_modules.heterogeneous_modules.HeteroGNNBase import HeteroGNNBase
from pc_mango.ggns.modules.gnn_modules.homogeneous_modules.GNNBase import GNNBase
from pc_mango.ggns.util.Types import ConfigDict
