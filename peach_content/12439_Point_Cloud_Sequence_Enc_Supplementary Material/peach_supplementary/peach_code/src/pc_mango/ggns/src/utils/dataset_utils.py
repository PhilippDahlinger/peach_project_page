...
def build_dataset_for_split(input_dataset: str,
    ...
    If hdf5_path is provided, uses HDF5 loader; otherwise uses pickle loader
    """
    # Route to HDF5 loader if path is provided
    if hdf5_path is not None:
        from pc_mango.ggns.src.utils.hdf5_dataset_utils import build_dataset_for_split_hdf5
        return build_dataset_for_split_hdf5(hdf5_path,
                                           path,
                                           split,
                                           edge_radius_dict,
                                           device,
