...
DATASET_FILE  = "../datasets/pc_mango/trampoline_v4.hdf5"
OUTPUT_FILE   = "../datasets/pc_mangotrampoline_v4_pcd_1cam_b_cropped.hdf5"
NUM_FINAL_PTS = 2048
cropping = {
    "x_min": -90, "x_max": 90,
    "y_min": -90, "y_max": 90,
...
def _worker_pickle_path(worker_id: int) -> str:
    return os.path.join(os.environ.get("TMP", "../datasets/pc_mango"), f"pcd_data_{worker_id:03d}.pkl")

def _worker_shard_path(worker_id: int) -> str:
    return os.path.join(os.environ.get("TMP", "../datasets/pc_mango"), f"pcd_shard_{worker_id:03d}.hdf5")
